...
def Custom():
	...
	Browser = input(green + "root@CyberPHToolKit/Device/Custom:~ ")
	print(alert + " Enter Device")
	Device = input("root@CyberPHToolKit/Device/Custom:~ ")
...
def AllNeed():
	...
	print("")
	DevicePick = int(input(green + "root@CyberPHToolKit/Device:~ " + white))
