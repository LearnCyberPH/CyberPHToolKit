...
def Facebook():
	...
	monthpick = int(input(green + "root@CyberPHToolKit/month:~ "))
...
def Gmail():
	...
	monthpick = int(input(green + "root@CyberPHToolKit:~ " + white))
...
def Spotify():
	...
	print(green + "[" + white + "12" + green + "]" + white + " December")
	print("")
	monthpick = int(input(green + "root@CyberPHToolKit/month:~ " + white))
	month = monthName(monthpick)
...
def RiotGames():
	...
	print("")
	ServerPick = int(input("root@CyberPHToolKit/RiotGames/Server:~ "))
