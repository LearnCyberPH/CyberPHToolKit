...
def RedirectHelp():
	...
	OptionPick = int(input(green + "root@CyberPHToolKit/Bypass/Redirect:~ " + white))
	if OptionPick == 1:
		os.system("clear")
		RedirectCreator()
	elif OptionPick == 2:
...
-------------------Creator-------------------""")
	...
	Creator = int(input(green + "root@CyberPHToolKit/Redirect/Creator:~ " + white))
	
	if Creator == 1:
		Url = input(start + "Enter Your Url: " + white)
		FileName = input(start + "Name Of File: " + white)
		print(alert + " Enter for '/root/Desktop/CyberPHToolKit/Redirection/'")
		FileSave = input(start + " Where Do You Want To Save The File?: " + white)
		if FileSave == "":
			 FileLocation = "/root/Desktop/CyberPHToolKit/Redirection/"
		else:
...
----------------Info And HowTo---------------""")
	...
	OptionPick = int(input(green + "root@CyberPHToolKit/Bypass/Redirect/Help:~ " + white))
