...
banner = f"""
        ...
        /  ` \ / |__) |__  |__) |__) |__|     |  /  \ /  \ |    |__/ |  | 
        \__,  |  |__) |___ |  \ |    |  |     |  \__/ \__/ |___ |  \ |  | \n
			</> Author: Tadashi Jei | CyberPH

	===========================================================
		Website: @cyberph.org Socials: @LearnCyberPH
	===========================================================
"""
...
def menu():
    ...
    print(alert + " More Versions Will Come Soon Stay Updated, Follow us on Github: @LearnCyberPH\n")
    print(white + "options:")
    print(
